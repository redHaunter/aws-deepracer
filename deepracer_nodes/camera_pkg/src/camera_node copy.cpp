...
namespace MediaEng {
    ...
    private:
                ...
                try {
                    ...
                    if (counter_ == 7){
                        ...
                        case 1:
                            ...
                            image_msg_left.data = jpeg_data_left;
                        ...
                        case 2:
                            ...
                            image_msg_left.data = jpeg_data_left;
                            image_msg_right.data = jpeg_data_right;
        ...
        sensor_msgs::msg::CompressedImage image_msg_left;
        sensor_msgs::msg::CompressedImage image_msg_right;
