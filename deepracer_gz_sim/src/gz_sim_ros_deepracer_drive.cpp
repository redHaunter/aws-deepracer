...
#include <deepracer_gz_plugin/gz_sim_ros_deepracer_drive.hpp>
...
namespace gazebo_plugins
{
    ...
    public:
        ...
        void OnUpdate(const gz::sim::UpdateInfo &_info);
        ...
        void PublishOdometryTf(const rclcpp::Time &_current_time);

        /// Publish odometry messages
        /// \param[in] _current_time Current simulation time
        void PublishOdometryMsg(const rclcpp::Time &_current_time);
    ...
    void GazeboRosDeepRacerDrive::Load(gazebo::physics::ModelPtr _model, sdf::ElementPtr _sdf)
    {
        ...
        // Initialize ROS node
        impl_->ros_node_ = rclcpp::Node::Get(_sdf);
        // Get QoS profiles
        const rclcpp::QoS &qos = impl_->ros_node_->get_qos();
        ...
        impl_->odom_.pose.pose.position = gz::sim::convert<geometry_msgs::msg::Point>(pose.Pos());
        impl_->odom_.pose.pose.orientation = gz::sim::convert<geometry_msgs::msg::Quaternion>(
            pose.Rot());
    ...
    void GazeboRosDeepRacerDrivePrivate::OnUpdate(const gz::sim::UpdateInfo &_info)
    {
    ...
    void GazeboRosDeepRacerDrivePrivate::UpdateOdometryWorld()
    {
        ...
        odom_.pose.pose.position = gz::sim::convert<geometry_msgs::msg::Point>(pose.Pos());
        odom_.pose.pose.orientation = gz::sim::convert<geometry_msgs::msg::Quaternion>(pose.Rot());
    ...
    void GazeboRosDeepRacerDrivePrivate::PublishOdometryTf(const rclcpp::Time &_current_time)
    {
        geometry_msgs::msg::TransformStamped msg;
        msg.header.stamp = gz::sim::convert<builtin_interfaces::msg::Time>(_current_time);
        msg.header.frame_id = odometry_frame_;
        msg.child_frame_id = robot_base_frame_;
        msg.transform.translation =
            gz::sim::convert<geometry_msgs::msg::Vector3>(odom_.pose.pose.position);
    ...
    void GazeboRosDeepRacerDrivePrivate::PublishOdometryMsg(const rclcpp::Time &_current_time)
    {
        // Set covariance
        ...
        odom_.header.stamp = gz::sim::convert<builtin_interfaces::msg::Time>(_current_time);
